...
public class NodeFactory
{
    ...
    public Node CreateNode(NodeDto node, Vector2 pos, Shader parent)
    {
        ...
        {
            Types.In => CreateInNode(node, pos, parent),
            Types.Function => CreateFunctionNode(node, pos, parent),
            Types.Uniform => CreateUniformNode(node, pos, parent),
            Types.Out => CreateOutNode(node, pos, parent),
